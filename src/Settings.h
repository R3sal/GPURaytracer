...
#define RT_SCENE_FILENAME "assets/testscene2.obj"
#define RT_MAX_RAYS_PER_PIXEL 1; //number of rays per pixel, the higher this value, the better AA and DOF effects will be
#define RT_MAX_RAY_DEPTH 4; //after shooting this number of rays, we return to shooting a ray from the camera
...
#define RT_MAX_SECONDS 600.0f //the maximum time in seconds bofore the raytracer finishes (this can be very useful for tesing and comparisons)

//camera settings
#define RT_CAMERA_FOV 1.2f //the field of view of the camera in radians
...
//for testscene2.obj
#define RT_CAMERA_POSITION { 0.0f, 0.0f, 0.0f }; //the position of the camera
#define RT_CAMERA_FOCUS_POINT { 1.0f, 0.0f, 0.0f }; //the point, the camera will look at
#define RT_CAMERA_UP_DIRECTION { 0.0f, 1.0f, 0.0f }; //adjusts, if the camera leans in a certain direction

//for testscene1.obj
//#define RT_CAMERA_POSITION { -4.0259f, 2.1676f, -2.9459f }; //the position of the camera
//#define RT_CAMERA_FOCUS_POINT { 0.0f, 0.0f, 0.0f }; //the point, the camera will look at
//#define RT_CAMERA_UP_DIRECTION { 0.0f, 1.0f, 0.0f }; //adjusts, if the camera leans in a certain direction

//for testobject4_2.obj
